...
async function ordenarSenadores( $sexo ) {
    ...
    $.each( $principiosEleccion,  function( key, principio ) {
        ...
        if( principio.id == 1 ){
            $senadorBuscar2 = $senadorBuscar.filter( senador => ( senador.orden_estado == '1' || senador.orden_estado == '2' ) && senador.id_estado !=='1'  );
            $(".contSenTotal1").html( '(' + $senadorBuscar2.length + ')'  );
        }
        if( principio.id == 2 ){
            $senadorBuscar2 = $senadorBuscar.filter( senador => ( senador.orden_estado == '3' ) && senador.id_estado !=='1'  );
            $(".contSenTotal2").html( '(' + $senadorBuscar2.length + ')'  );
        }

        if( principio.id == 3 ){
            $senadorBuscar2 = $senadorBuscar.filter( senador => ( senador.orden_estado == '1') && senador.id_estado =='1'  );
